...
SELECT m.name as model_name, b.name as brand_name, b.headquarters as headquarters 
FROM brands as b
JOIN models as m
...
SELECT * FROM models OFFSET 14 LIMIT 10;
...
SELECT m.year as year, m.name as name, m.model_id as model_id, a.name as name
FROM models as m
...
SELECT b.name as name, b.founded as year FROM brands as b LEFT JOIN models as m ON m.brand_id = b.brand_id WHERE m.model_id IS NULL;
